#ifndef LIBS_LIBCPP_INCLUDE_INTERNAL_TUPLE_BASE_HPP_
#define LIBS_LIBCPP_INCLUDE_INTERNAL_TUPLE_BASE_HPP_
...
#endif  // LIBS_LIBCPP_INCLUDE_INTERNAL_TUPLE_BASE_HPP_
