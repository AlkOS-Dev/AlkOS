...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wall -Wextra -ffreestanding -mstackrealign -ffile-prefix-map=${CMAKE_ROOT_DIR}/=")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wall -Wextra -ffreestanding -fno-exceptions -fno-rtti -mstackrealign -ffile-prefix-map=${CMAKE_ROOT_DIR}/=")
