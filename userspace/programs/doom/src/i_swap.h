...
#ifndef USERSPACE_PROGRAMS_DOOM_SRC_I_SWAP_H_
#define USERSPACE_PROGRAMS_DOOM_SRC_I_SWAP_H_
...
static inline unsigned short swapLE16(unsigned short val) { return ((val << 8) | (val >> 8)); }
...
#endif  // USERSPACE_PROGRAMS_DOOM_SRC_I_SWAP_H_
