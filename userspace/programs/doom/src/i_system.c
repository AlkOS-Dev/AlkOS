...
static int ZenityAvailable(void) { return false; }
...
static int ZenityErrorBox(char *message) { return 0; }
...
void I_Error(char *error, ...)
{
...
#elif defined(__MACOSX__)
    {
        ...
        CFUserNotificationDisplayNotice(
            0, kCFUserNotificationCautionAlertLevel, NULL, NULL, NULL, CFSTR(PACKAGE_STRING),
            message, NULL
        );
    }
