...
function(alkos_register_runtime_environment)
    ...
    set(BASH_CONF_FILE "${CMAKE_BINARY_DIR}/conf.${ARG_ARCH_NAME}.bash")
    ...
    add_custom_target(iso-${ARG_ARCH_NAME}
        COMMAND ${MAKE_ISO_SCRIPT_PATH} -v --conf "${BASH_CONF_FILE}"
    ...
    add_custom_target(run-${ARG_ARCH_NAME}
        COMMAND ${RUN_ALKOS_SCRIPT_PATH} -v --conf "${BASH_CONF_FILE}"
    ...
    add_custom_target(run-with-gdb-${ARG_ARCH_NAME}
        COMMAND ${RUN_ALKOS_SCRIPT_PATH} -v --gdb --conf "${BASH_CONF_FILE}"
        DEPENDS iso-${ARG_ARCH_NAME}
        WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
    ...
    add_custom_target(mount-${ARG_ARCH_NAME}
        COMMAND ${RUN_ALKOS_SCRIPT_PATH} -v --mount --conf "${BASH_CONF_FILE}"
        DEPENDS iso-${ARG_ARCH_NAME}
        WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
