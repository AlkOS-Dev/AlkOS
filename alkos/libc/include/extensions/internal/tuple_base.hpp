#ifndef ALKOS_LIBC_INCLUDE_EXTENSIONS_INTERNAL_TUPLE_BASE_HPP_
#define ALKOS_LIBC_INCLUDE_EXTENSIONS_INTERNAL_TUPLE_BASE_HPP_
...
#endif  // ALKOS_LIBC_INCLUDE_EXTENSIONS_INTERNAL_TUPLE_BASE_HPP_
