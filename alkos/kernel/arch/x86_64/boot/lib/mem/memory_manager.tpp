#ifndef ALKOS_BOOT_LIB_MEM_MEMORY_MANAGER_TPP_
#define ALKOS_BOOT_LIB_MEM_MEMORY_MANAGER_TPP_
...
)
{
    ...
    if (mapped_bytes < size_bytes) {
        FAIL_ALWAYS("Failed to map virtual memory range - out of memory!");
    }
}
...
#endif  // ALKOS_BOOT_LIB_MEM_MEMORY_MANAGER_TPP_
