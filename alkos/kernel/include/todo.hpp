...
#define TODO_STD_OPTIONAL
#define TODO_STD_VARIANT

#define TODO_WHEN_TYPETRAITS_MERGED
#define TODO_WHEN_DEBUGGING_FRAMEWORK
#define TODO_WHEN_TIMER_INFRA_DONE
#define TODO_DEVICE_SUPPORT
#define TODO_CLOCK_VALIDATION
#define TODO_MMU_MINIMAL
